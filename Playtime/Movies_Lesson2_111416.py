...
movie_titles = ["Titanic","Juno","Avatar","Beauty and the Beast","Lion King"] 
parental_guidance= ["R", "R","PG","G","G"]
bechdel_rating= ["N","N", "N","Y","Y"]
IMDB_rating =[7.7, 7.5,7.9,8.0,8.5]
genre = ["Romance", "Comedy", "SciFi", "Disney", "Disney"]
films = zip(movie_titles, parental_guidance, bechdel_rating, IMDB_rating, genre)
